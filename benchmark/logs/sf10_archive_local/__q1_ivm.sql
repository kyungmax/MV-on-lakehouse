...
REFRESH MATERIALIZED VIEW my_rest.tpch.q1mv;
...
REFRESH MATERIALIZED VIEW my_rest.tpch.q1mv;DELETE FROM my_rest.tpch.orders
...
order by
  ...
  l_linestatus;
drop materialized view my_rest.tpch.q1mv;
SELECT concat('sf1,q1,ivm,',(unix_millis(current_timestamp()) - t0.t0s)) AS e2e_csv FROM my_rest.tpch._t0 t0;
EXIT;
