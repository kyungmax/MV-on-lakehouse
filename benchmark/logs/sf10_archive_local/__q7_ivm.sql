...
SELECT * FROM rf_orders;REFRESH MATERIALIZED VIEW my_rest.tpch.q7mv;
...
REFRESH MATERIALIZED VIEW my_rest.tpch.q7mv;
...
SELECT concat('sf1,q7,ivm,',(unix_millis(current_timestamp()) - t0.t0s)) AS e2e_csv FROM my_rest.tpch._t0 t0;
EXIT;
