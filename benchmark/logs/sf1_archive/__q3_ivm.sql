...
REFRESH MATERIALIZED VIEW my_rest.tpch.q3mv;INSERT INTO my_rest.tpch.lineitem
...
REFRESH MATERIALIZED VIEW my_rest.tpch.q3mv;DELETE FROM my_rest.tpch.orders
...
SELECT concat('sf1,q3,ivm,',(unix_millis(current_timestamp()) - t0.t0s)) AS e2e_csv FROM my_rest.tpch._t0 t0;
EXIT;
