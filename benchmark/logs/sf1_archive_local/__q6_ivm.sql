...
SELECT * FROM rf_orders;REFRESH MATERIALIZED VIEW my_rest.tpch.q6mv;
...
REFRESH MATERIALIZED VIEW my_rest.tpch.q6mv;
...
where
  ...
  DROP MATERIALIZED VIEW IF EXISTS my_rest.tpch.q6mv;
SELECT concat('sf1,q6,ivm,',(unix_millis(current_timestamp()) - t0.t0s)) AS e2e_csv FROM my_rest.tpch._t0 t0;
EXIT;
