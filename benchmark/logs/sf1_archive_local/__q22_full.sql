...
group by
  cntrycode
order by
  cntrycode;DROP MATERIALIZED VIEW IF EXISTS my_rest.tpch.q22mv;SELECT concat('sf1,q22,full,',(unix_millis(current_timestamp()) - t0.t0s)) AS e2e_csv FROM my_rest.tpch._t0 t0;
EXIT;
